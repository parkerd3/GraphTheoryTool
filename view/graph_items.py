...
ROTATION_CONTROL_GUIDE_BRUSH = QBrush(QColor(242, 140, 40, 35))
ROTATION_CONTROL_STEM_PEN = QPen(QColor(242, 140, 40, 150), 2)
ROTATION_CONTROL_HANDLE_BRUSH = QBrush(QColor(242, 140, 40, 190))
ROTATION_CONTROL_HANDLE_PEN = QPen(QColor("#16324f"), 2)
